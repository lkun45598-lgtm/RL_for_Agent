...
@description Experiment #30: multi-scale rel L2 + gradient + FFT, scale_weights=[0.85,0.1,0.05]
    Near single-scale but with tiny coarse regularization.
