...
from loss_transfer.generation.llm_extractor import call_llm
...
from loss_transfer.common.paths import WORKFLOW_LOSS_TRANSFER_DIR
...
def _load_target_interface_spec() -> str:
    ...
    spec_file = WORKFLOW_LOSS_TRANSFER_DIR / 'target_interface_spec.yaml'
    if spec_file.exists():
...
def _load_blocked_patterns() -> str:
    ...
    blocked_file = WORKFLOW_LOSS_TRANSFER_DIR / 'blocked_patterns.yaml'
